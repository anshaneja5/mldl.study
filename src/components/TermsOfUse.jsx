      ...
      <div className="flex min-h-screen flex-col">
        ...
        <main className="mx-auto w-full max-w-3xl flex-grow px-4 pb-20 pt-10 sm:pt-14">
          <h1 className="mb-8 text-center font-display text-4xl uppercase tracking-tight text-ink sm:text-5xl">
            Terms of <span className="inline-block rotate-[-1deg] bg-electric px-2 text-white shadow-brut-sm">Use</span>
          </h1>
          <div className="brut-card space-y-4 p-6 text-soft sm:p-9">
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">1. Acceptance of Terms</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">2. Description of Service</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">3. Use License</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">4. Educational Purpose</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">5. External Links and Resources</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">6. User Conduct</h2>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">7. Intellectual Property</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">8. Disclaimer of Warranties</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">9. Limitation of Liability</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">10. User-Generated Content</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">11. Modifications to Service</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">12. Privacy</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">13. Governing Law</h2>
            <p>
              These Terms of Use shall be governed by and construed in accordance with applicable laws, without 
              regard to conflict of law provisions.
            </p>

            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">14. Open Source</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">15. Contact Information</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">16. Severability</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 font-display text-2xl uppercase text-ink">Acknowledgment</h2>
            <p>
